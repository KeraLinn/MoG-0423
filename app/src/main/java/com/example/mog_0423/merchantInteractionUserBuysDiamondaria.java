...
public class merchantInteractionUserBuysDiamondaria extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void completeTransaction() {
        ...
        if (playerPurse <= 0){
            startActivity(new Intent(merchantInteractionUserBuysDiamondaria.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setNegativeButton("No thanks", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(merchantInteractionUserBuysDiamondaria.this, cityTravel.class));
            }
        });
        builder.show();
    }
