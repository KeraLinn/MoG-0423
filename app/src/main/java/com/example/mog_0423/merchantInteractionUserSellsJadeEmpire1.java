...
public class merchantInteractionUserSellsJadeEmpire1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void completeTransaction() {
        ...
        if (playerPurse >= 1000){
            startActivity(new Intent(merchantInteractionUserSellsJadeEmpire1.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Bye!", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserSellsJadeEmpire1.this, merchantInteractionUserBuysRubya2.class));
            }
        });
        builder.show();
    }
