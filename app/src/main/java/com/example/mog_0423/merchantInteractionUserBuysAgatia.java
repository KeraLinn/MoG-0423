...
public class merchantInteractionUserBuysAgatia extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void completeTransaction() {
        ...
        if (playerPurse <= 0){
            startActivity(new Intent(merchantInteractionUserBuysAgatia.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setNegativeButton("No thanks", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(merchantInteractionUserBuysAgatia.this, cityTravel.class));
            }
        });
        builder.show();
    }
