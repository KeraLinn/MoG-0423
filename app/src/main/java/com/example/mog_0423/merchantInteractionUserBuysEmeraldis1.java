...
public class merchantInteractionUserBuysEmeraldis1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    ArrayList<Commodity> cityStockArrayList = commodity.getEmeraldisCommodityArrayList();
    ...
    private void setUpScreenAttachments() {
        ...
        merchantAvatar.setImageResource(R.drawable.icons8_avatar_64_mf);
    ...
    private void completeBuy() {
        ...
        if (playerPurse <= 0){
            startActivity(new Intent(merchantInteractionUserBuysEmeraldis1.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserBuysEmeraldis1.this,
                        merchantInteractionUserSellsEmeraldis1.class));
            }
        });
        builder.setNegativeButton("No thanks", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(merchantInteractionUserBuysEmeraldis1.this,
                        merchantInteractionUserBuysEmeraldis2.class));
            }
        });
        builder.show();
    }
