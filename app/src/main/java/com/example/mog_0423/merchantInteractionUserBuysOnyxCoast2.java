...
public class merchantInteractionUserBuysOnyxCoast2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void completeBuy() {
        ...
        if (playerPurse <= 0){
            startActivity(new Intent(merchantInteractionUserBuysOnyxCoast2.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserBuysOnyxCoast2.this,
                        merchantInteractionUserSellsOnyxCoast2.class));
            }
        });
