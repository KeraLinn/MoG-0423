...
public class merchantInteractionUserBuysOnyxCoast1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    ArrayList<Commodity> cityStockArrayList = commodity.getOnyxCoastCommodityArrayList();
    ...
    private void setUpScreenAttachments() {
        ...
        merchantAvatar.setImageResource(R.drawable.icons8_avatar_64_fgrey);
    ...
    private void completeBuy() {
        ...
        if (playerPurse <= 0){
            startActivity(new Intent(merchantInteractionUserBuysOnyxCoast1.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserBuysOnyxCoast1.this,
                        merchantInteractionUserSellsOnyxCoast1.class));
            }
        });
        builder.setNegativeButton("No thanks", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(merchantInteractionUserBuysOnyxCoast1.this,
                        merchantInteractionUserBuysOnyxCoast2.class));
            }
        });
        builder.show();
    }
