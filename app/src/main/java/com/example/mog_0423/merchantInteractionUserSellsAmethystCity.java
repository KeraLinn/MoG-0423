...
public class merchantInteractionUserSellsAmethystCity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void completeTransaction() {
        ...
        if (playerPurse >= 1000){
            startActivity(new Intent(merchantInteractionUserSellsAmethystCity.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Bye!", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserSellsAmethystCity.this, cityTravel.class));
            }
        });
        builder.show();
    }
