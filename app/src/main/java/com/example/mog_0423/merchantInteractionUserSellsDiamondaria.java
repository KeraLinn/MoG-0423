...
public class merchantInteractionUserSellsDiamondaria extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void setUpScreenAttachments() {
        ...
        merchantAvatar.setImageResource(R.drawable.icons8_avatar_64_fblue);
    ...
    private void completeTransaction() {
        ...
        if (playerPurse >= 1000){
            startActivity(new Intent(merchantInteractionUserSellsDiamondaria.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Bye!", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserSellsDiamondaria.this, cityTravel.class));
            }
        });
        builder.show();
    }
