...
public class merchantInteractionUserBuysAmethystCity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void setUpScreenAttachments() {
        ...
        merchantAvatar.setImageResource(R.drawable.icons8_avatar_64_f_red);
    ...
    private void completeTransaction() {
        ...
        if (playerPurse <= 0){
            startActivity(new Intent(merchantInteractionUserBuysAmethystCity.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserBuysAmethystCity.this,
                        merchantInteractionUserSellsAmethystCity.class));
            }
        });
        builder.setNegativeButton("No thanks", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(merchantInteractionUserBuysAmethystCity.this, cityTravel.class));
            }
        });
        builder.show();
    }
