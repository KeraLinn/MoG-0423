...
public class merchantInteractionUserBuysTourmalina extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    ArrayList<Commodity> cityStockArrayList = commodity.getTourmalinaCommodityArrayList();
    ...
    private void completeTransaction() {
        ...
        if (playerPurse <= 0){
            startActivity(new Intent(merchantInteractionUserBuysTourmalina.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserBuysTourmalina.this,
                        merchantInteractionUserSellsTourmalina.class));
            }
        });
        builder.setNegativeButton("No thanks", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(merchantInteractionUserBuysTourmalina.this, cityTravel.class));
            }
        });
        builder.show();
    }
