...
public class merchantInteractionUserSellsOpalancy2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void completeTransaction() {
        ...
        if (playerPurse >= 1000){
            startActivity(new Intent(merchantInteractionUserSellsOpalancy2.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Bye!", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserSellsOpalancy2.this, cityTravel.class));
            }
        });
        builder.show();
    }
