...
public class merchantInteractionUserBuysOpalancy1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    ArrayList<Commodity> cityStockArrayList = commodity.getOpalancyCommodityArrayList();
    ...
    private void setUpScreenAttachments() {
        ...
        merchantAvatar.setImageResource(R.drawable.icons8_avatar_64_mpink);
    ...
    private void completeBuy() {
        ...
        if (playerPurse <= 0){
            startActivity(new Intent(merchantInteractionUserBuysOpalancy1.this, gameOver.class));
        }
        playerGold.setText(String.valueOf(playerPurse));
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(merchantInteractionUserBuysOpalancy1.this,
                        merchantInteractionUserSellsOpalancy1.class));
            }
        });
        builder.setNegativeButton("No thanks", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(merchantInteractionUserBuysOpalancy1.this,
                        merchantInteractionUserBuysOpalancy2.class));
            }
        });
        builder.show();
    }
